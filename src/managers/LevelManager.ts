...
const LEVELS: Level[] = [
  ...
  new Level({ name: 'Poziom 2', playerSpeed: 520, spawnFoodInterval: 3500, maxLives: 10, scoreToAdvance: 30 }),
  new Level({ name: 'Poziom 3', playerSpeed: 650, spawnFoodInterval: 2500, maxLives: 5, scoreToAdvance: 40 }),
];
